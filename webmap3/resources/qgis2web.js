...
map.getView().fit([676147.079455, 710559.007640, 778537.023016, 769498.051128], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Water Filtration</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1068 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map sheds light on the role various land types play in maintaining water quality within Dublin. Darker colors represent land that acts as a natural filter, effectively removing sediment and impurities from water, thus contributing to a cleaner water environment. Conversely, lighter colors indicate areas that may potentially introduce pollutants into the water system.<br />Clean water is vital for human health and the ecological health of the entire region. Understanding how land influences water quality empowers us to make informed decisions for its protection.<br />The map was developed using:<br />Teagasc National Soils and Subsoils Data (soil type)<br />Compiled Habitat Map (landform and habitats)<br />Scientific Models (predicting water filtration and pollutant input)<br />Important Note: This map provides a strategic overview based on the best available data. For highly specific information on water quality at a particular location, a detailed field survey is recommended.<br />Source: https://dahg.maps.arcgis.com/apps/MapSeries/index.html?appid=cb5040a4a19645b6b424bed940c54fff';
            }
