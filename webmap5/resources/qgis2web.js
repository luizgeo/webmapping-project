...
map.getView().fit([666773.948224, 713145.669472, 763601.990208, 768883.098157], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Terrestrial Food</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1319 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map sheds light on the distribution of food production resources across Dublin. The main map utilizes a color gradient, with darker tones signifying areas of high food production, primarily dominated by cultivated crops and improved pastures. Conversely, lighter colors represent areas with lower food production potential, suitable for wild food foraging activities like gathering mushrooms and hunting game.<br />The inset further emphasizes areas with predominant agricultural land use, highlighted in orange.<br />This information is crucial in a world facing a growing population and increasing demand for land for housing, infrastructure, and resource extraction. Understanding the current landscape of food production resources is paramount for strategic land-use planning. Effective planning ensures a sustainable future by balancing food security with development requirements.<br />The map was created using data from:<br />Land Parcel Information System (cropping types)<br />Teagasc (soil data)<br />NPWS (habitat data)<br />Important Note: This map is intended for strategic planning and not for precise assessments at individual farm levels. On-site analysis is necessary for a comprehensive understanding of individual land parcels.<br />Source: https://dahg.maps.arcgis.com/apps/MapSeries/index.html?appid=cb5040a4a19645b6b424bed940c54fff';
            }
