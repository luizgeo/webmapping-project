...
map.getView().fit([680107.446372, 712607.631504, 776869.656743, 768307.165331], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Vegetation Carbon</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1156 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This map highlights areas within Dublin that play a significant role in carbon sequestration. Darker colors indicate regions with higher vegetation carbon storage, primarily associated with mature woodlands. Lighter colors represent areas where vegetation carbon may be removed annually, such as grasslands and bare ground.<br />Terrestrial ecosystems, particularly forests, act as carbon sinks, absorbing atmospheric carbon dioxide and storing it in their biomass. By understanding the distribution of carbon-rich vegetation, we can identify areas crucial for mitigating climate change.<br />Data Sources:<br />Corine Land Cover<br />FIPS Forest 07 and Forest 12<br />NPWS (Article 17, National Survey of Native Woodlands 2003-2008; and Ancient and Long-established Woodland Inventory 2010)<br />Land Parcel Information System (LPIS)<br />Important Note: While this map provides a valuable overview of carbon sequestration potential, it\'s essential to acknowledge the limitations of the LPIS data, which may underestimate the carbon storage capacity of semi-natural grasslands and heaths.<br />Source: https://dahg.maps.arcgis.com/apps/MapSeries/index.html?appid=cb5040a4a19645b6b424bed940c54fff';
            }
